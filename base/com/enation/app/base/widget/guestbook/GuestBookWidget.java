 ...
 * 留言板挂件
 * 
 * @author kingapex 2010-8-14下午09:09:55
 */
public class GuestBookWidget extends AbstractWidget {
	...
	protected void list(int pageSize) {
		...
		Page page = this.guestBookManager.list(null, Integer.valueOf(pageNo),
				pageSize);
		this.putData("subjectList", page.getResult());

		FacadePagerHtmlBuilder pagerHtmlBuilder = new FacadePagerHtmlBuilder(
				Integer.valueOf(pageNo), page.getTotalCount(), pageSize);
	...
	private int validcode(String validcode) {
		...
		String code = (String) ThreadContextHolder
				.getSessionContext()
				.getAttribute(ValidCodeServlet.SESSION_VALID_CODE + "guestbook");
		if (code == null) {
			return 0;
		} else {
