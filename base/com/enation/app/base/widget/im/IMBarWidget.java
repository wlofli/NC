 ...
 * 客服挂件
 * 
 * @author kingapex 2010-9-15下午05:56:14
 */
public class IMBarWidget extends AbstractWidget {
	...
	protected void display(Map<String, String> params) {
		...
		// 营业时间
		String worktime = site.getWorktime();// settingService.getSetting("im",
												// "worktime");
		String tellist = site.getTellist();// settingService.getSetting("im",
											// "tel");
