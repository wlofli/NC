 ...
 * 问答管理接口
 * 
 * @author kingapex 2010-8-7下午04:00:03
 */
public interface IAskManager {
	 ...
	 * 
	 * @param ask
	 *            实体中不包含上述信息， 只包含问题本身信息
	 */
	public void add(Ask ask);

	/**
	 * 回复<br>
	 * <li>调用者要设置reply的askid、username及其它基本信息</li> <li>实现者要记录回复时间。</li>
	 * 
	 * @param ask
	 */
	 ...
	 * 
	 * @param keyword
	 *            关键字，可搜索title和content，为空则不以此条件筛选
	 * @param startTime
	 *            开始时间条件,为空则不以此条件筛选
	 * @param endTime
	 *            结束时间,为空则不以此条件筛选
	 ...
	 * 
	 * @param keyword
	 *            关键字，可搜索title、content、站点名称，提问人名称、域名，为空则不以此条件筛选
	 * @param startTime
	 *            开始时间条件,为空则不以此条件筛选
	 * @param endTime
	 *            结束时间,为空则不以此条件筛选
