 ...
 * 资源管理器
 * 
 * @author kingapex 2010-8-18下午06:14:44
 */
public class ExplorerManager implements IExplorerManager {
	...
	public ExplorerManager(String rootPath) {
		if (rootPath == null)
			throw new IllegalArgumentException("param rootPath is NULL");
		this.rootPath = rootPath;
	}

	public void add(FileNode node) throws IOException {
		if (node == null)
			throw new IllegalArgumentException("param FileNode is NULL");
	...
	public void upload(File file, String fileFileName) {
		...
		if (temp.exists())
			throw new RuntimeException("文件" + fileFileName + "已经存在");
