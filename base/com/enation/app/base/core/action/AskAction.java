 ...
 * 问题action
 * 
 * @author kingapex 2010-8-10上午11:47:56
 */
public class AskAction extends WWAction {
	...
	public String listAll() {
		keyword = StringUtil.isEmpty(keyword) ? null : StringUtil
				.toUTF8(keyword);
		Date start = StringUtil.isEmpty(startTime) ? null : DateUtil.toDate(
				startTime, "yyyy-MM-dd");
		Date end = StringUtil.isEmpty(endTime) ? null : DateUtil.toDate(
				endTime, "yyyy-MM-dd");
		this.webpage = this.askManager.listAllAsk(keyword, start, end,
	...
	public String listMy() {
		...
		Date end = StringUtil.isEmpty(endTime) ? null : DateUtil.toDate(
				endTime, "yyyy-MM-dd");
		this.webpage = this.askManager.listMyAsk(keyword, start, end,
				this.getPage(), this.getPageSize());
