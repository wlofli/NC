...
public  class StringUtil {
	 ...
	 * 
	 */
	public static String changePercent(String string){
		String newString = string.replaceAll("所有", "%");
		return newString;
	}
	
	public static String addPercent(String string){
		String newString = string.replaceAll(string, "%"+string+"%");
		return newString;
	}
