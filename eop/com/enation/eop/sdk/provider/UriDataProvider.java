...
public class UriDataProvider implements DataProvider {
	 ...
	 * @param httpResponse
	 */
	public UriDataProvider(HttpServletRequest httpRequest,
			HttpServletResponse httpResponse, String url) {
	...
	public Object load(Map<String, String> params) {
		...
		String content = JspUtil.getJspOutput(this.url, this.httpRequest,
				this.httpResponse);
