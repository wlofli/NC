...
public class GridCellProvider extends AbstractPluginsBundle {
	...
	/**
	 * 
	 * 得到排序开始操作的字串 将排序的起连接字串分开 因为是点击cell中的字排序
	 * 
	 * @return
	 */
	...
	/**
	 * 
	 * 得到排序结速操作的字串 将排序的起连接字串分开 因为是点击cell中的字排序
	 * 
	 * @return
	 */
	...
	public String getEndHtml() {
		...
		StringBuffer buffer = new StringBuffer();
		if (plugin_type != null)
			this.performPlugins("grid_cell_plugin", this.plugin_type,
					this.request, response, buffer, isTh);
		str += buffer.toString();
