 ...
 * 用户详细信息管理
 * 
 * @author kingapex 2010-5-10下午12:36:16
 */
public class UserDetailManagerImpl implements IUserDetailManager {
	...
	public void edit(EopUserDetail eopUserDetail) {
		this.daoSupport.update("eop_userdetail", eopUserDetail, " userid = "
				+ eopUserDetail.getUserid());
	}

	public EopUserDetail get(Integer userid) {
		return this.daoSupport.queryForObject(
				"select * from eop_userdetail where userid = ?",
