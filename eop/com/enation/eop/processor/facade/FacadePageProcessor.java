...
public class FacadePageProcessor implements Processor {
	...
	/**
	 * 
	 * 响应页面的三种操作,通过参数_method来识别，并分别通过三个接口来完成操作： <li>GET:解析页面：
	 * {@link com.enation.eop.processor.IPagePaser}</li> <li>PUT:更新页面 ：
	 * {@link com.enation.eop.processor.IPageUpdater}</li> <li>
	 * PARAMJSON:获取页面挂件参数json串com.enation.eop.api.facade.IPageParamJsonGetter</li>
	 * </br> 页面的url会被读取并做为解析实际页面文件地址的依据
	 * 
	 * @param mode
	 * @param httpResponse
	 * @param httpRequest
