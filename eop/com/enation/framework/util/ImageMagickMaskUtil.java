 ...
 * 图片文字水印工具类
 * 
 * @author kingapex 2010-8-25下午05:40:04
 */
public class ImageMagickMaskUtil {
	 ...
	 *            水印的y坐标
	 * @param fontPath
	 *            字体路径 ，如果是中文要传给相应字体（ttf）的路径。如果是英文可以传为null
	 */
	public void mask(String source, String text, String fontcolor,
			int fontsize, int pos, String fontPath) {
		try {
			...
			int textwidth = 100;
			int textheight = 20;
			int[] xy = this.getXy(width.intValue(), height.intValue(),
					textwidth, textheight, pos);
	...
	private int[] getXy(int width, int height, int textwidth, int textheight,
			int pos) {
