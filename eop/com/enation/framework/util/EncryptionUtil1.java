 ...
 * 加密工具
 * 
 * @author kingapex 2010-3-22下午03:41:11
 */
public class EncryptionUtil1 {
	 ...
	 */
	public static String authcode(String $string, String $operation,
	...
	private static String base64_decode(String input) {
		try {
			return new String(com.enation.framework.util.Base64.decode(input
	...
	public static void main(String[] args) {
		// for(int i = 0; i < 100; i++){
		// String number = "" + Math.random()+ Math.random()+ Math.random()+
		// Math.random();
		// System.out.println("加密前：" + number);
		// String number2 = EncryptionUtil.authcode(number, "ENCODE","",0);
		// System.out.println("加密后：" + number2);
		// System.out.println("解密后：" + EncryptionUtil.authcode(number2,
		// "DECODE","",0));
		// System.out.println();
		// }
		System.out.println(EncryptionUtil1.authcode("9,1319258194668",
				"ENCODE", "", 0));
		System.out
				.println(EncryptionUtil1
						.authcode(
								"0fb7Ys0fSwwMXGtXZhtVN9GqUQ7z7r.3.nlfiTBCPSSd.2.d1MmDRFCq8AaOh5I.1.",
								"DECODE", "", 0));
	}
