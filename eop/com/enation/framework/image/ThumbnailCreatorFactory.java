 ...
 * 缩略图生成器工厂<br>
 * 
 * @author kingapex 2010-7-10下午11:40:28
 */
public abstract class ThumbnailCreatorFactory {
	 ...
	 * @param target
	 *            图片缩略图路径
	 * @return 当{@link #CREATORTYPE} 为javaimageio时使用{@link JavaImageIOCreator }
	 *         生成器<br>
	 *         当{@link #CREATORTYPE} 为imagemagick时使用{@link ImageMagickCreator }
	 *         生成器<br>
	 */
	public static final IThumbnailCreator getCreator(String source,
			String target) {
