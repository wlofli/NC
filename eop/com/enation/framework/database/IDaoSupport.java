 ...
 * 数据库操作支撑接口
 * 
 * @author kingapex 2010-1-6下午01:33:13
 * @param <T>
 */
public interface IDaoSupport<T> {
	 ...
	 * 
	 * @param sql
	 *            查询的sql语句,确保结果列名和对象属性对应
	 * @param clazz
	 *            <code>T</code>的Class对象
	 * @param args
	 *            对应sql语句中的参数值
	 * @return
	 */
