...
/**
 * 
 * 可插件化业务基类,提供插件桩基本功能<br/>
 * 本类首先继承了 BaseManager，具有操作数据库的能力。<br/>
 * 本类实现了IPluginBundle接口，使其具有了插件桩化的能力。<br/>
 * 本类为抽像类，定义了一些插件桩公用的方法，将一插件按照type为key注册到一个map中,<br/>
 * 执行某类多个插件的功能。<br/>
 * 一般性业务类需要插件桩化建议继承此类。
 * 
 * @author apexking
 * 
 */
public abstract class AbstractDBPluginsBundle implements IPluginBundle {
