...
public class SearchTest extends SpringTestSupport {
	...
	/**
	 * String cat_path = params.get("cat_path"); String order =
	 * params.get("order"); String brandStr = params.get("brandStr"); String
	 * propStr = params.get("propStr"); String keyword = params.get("keyword");
	 * String minPrice = params.get("minPrice"); String maxPrice =
	 * params.get("maxPrice");
	 */
