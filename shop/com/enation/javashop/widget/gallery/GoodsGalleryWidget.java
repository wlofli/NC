...
public class GoodsGalleryWidget extends AbstractGoodsDetailWidget {
	...
	protected void execute(Map<String, String> params, Map goods) {
		...
		String image_file = goods.get("image_file") == null ? "" : goods.get(
				"image_file").toString();
		...
		if (image_file != null && !image_file.equals("")) {
			...
			String img = EopSetting.IMG_SERVER_DOMAIN
		...
		String album_pic_width = this.settingService.getSetting("photo",
				"detail_pic_width");
		String album_pic_height = this.settingService.getSetting("photo",
				"detail_pic_height");
