 ...
 * 对比商品挂件
 * 
 * @author kingapex 2010-4-28下午01:47:47
 */
public class CompareGoodsWidget extends AbstractWidget {
	...
	protected void display(Map<String, String> params) {
		...
		String goodsStr = HttpUtil.getCookieValue(
				ThreadContextHolder.getHttpRequest(), "cmpgoods");
	...
	public List fillDiffProps(List<GoodsView> goodsList) {
		...
		// 读取这种类型的属性信息列表
		List propList = this.goodsTypeManager.getAttrListByTypeId(goodsList
				.get(0).getType_id());
