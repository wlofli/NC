 ...
 * 会员预存款挂件
 * 
 * @author kingapex 2010-9-25上午11:57:57
 */
public class MemberDepositWidget extends AbstractMemberWidget {
	...
	private void pay() {
		...
		IPaymentEvent paymentPlugin = SpringContextHolder.getBean(payCfg
				.getType());
	...
	protected String getCallBackUrl() {
		...
		return "http://" + serverName + ":" + port + contextPath
				+ "/member_deposit.html?action=callback&paymentid=" + paymentId;
	}
	...
	protected String getShowUrl() {
		...
		String contextPath = request.getContextPath();
		return "http://" + serverName + ":" + port + contextPath
				+ "/widget?type=paywidget&action=show&paymentid=" + paymentId;
	}
