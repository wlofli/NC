...
public class MemberCouponsMemberWidget extends AbstractMemberWidget {
	...
	protected void display(Map<String, String> params) {
		...
		String mc_use_times = settingService.getSetting("coupons",
				"coupon.mc.use_times");
		...
		int pageSize = 20;
		Page pageMemberCoupons = memberCouponsManager.pageMemberCoupons(
		...
		listMemberCoupons = listMemberCoupons == null ? new ArrayList()
				: listMemberCoupons;
	...
	public void setMemberCouponsManager(
