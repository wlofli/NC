...
public class MemberPointHistoryWidget extends AbstractMemberWidget {
	...
	protected void display(Map<String, String> params) {
		...
		int pointType = StringUtil.toInt(request.getParameter("pointtype"),
				true);

		page = (page == null || page.equals("")) ? "1" : page;
		int pageSize = 20;
		Page pointHistoryPage = pointHistoryManager.pagePointHistory(
				Integer.valueOf(page), pageSize, pointType);
