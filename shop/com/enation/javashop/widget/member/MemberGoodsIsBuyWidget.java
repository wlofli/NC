...
public class MemberGoodsIsBuyWidget extends AbstractWidget {
	...
	protected void display(Map<String, String> params) {
		Map goods = (Map) ThreadContextHolder.getHttpRequest().getAttribute(
				"goods");
		if (goods == null)
			throw new RuntimeException("员是否购买过某商品挂件必须和商品详细显示挂件同时存在");
		boolean isBuy = this.memberOrderManager.isBuy((Integer) goods
				.get("goods_id"));
