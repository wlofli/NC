...
public class TenpayDirectPlugin extends AbstractPaymentPlugin implements
	...
	public String onPay(PayCfg payCfg, Order order) {
		...
		/*
		 * String show_url = this.getShowUrl(order); String notify_url =
		 * this.getCallBackUrl(payCfg); String return_url
		 * =this.getReturnUrl(payCfg);
		 */
		...
		reqHandler.setParameter("total_fee",
				formatPrice(order.getOrder_amount() * 100)); // 商品金额,以分为单位
