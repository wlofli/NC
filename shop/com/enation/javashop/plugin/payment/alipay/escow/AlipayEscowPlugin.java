...
public class AlipayEscowPlugin extends AbstractPaymentPlugin implements
		IPaymentEvent {
	...
	public String onPay(PayCfg payCfg, Order order) {
		...
		System.out.println("out_trade_no[" + out_trade_no + "]-partner["
				+ partner + "]-key[" + key + "]-seller_email[" + seller_email
				+ "]");
		...
		return AlipaySubmit.buildForm(sParaTemp,
				AlipayService.ALIPAY_GATEWAY_NEW, "get", key);
