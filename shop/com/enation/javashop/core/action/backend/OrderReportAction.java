...
public class OrderReportAction extends WWAction {
	...
	public String paymentList() {
		this.webpage = orderReportManager.listPayment(this.getPage(),
				this.getPageSize(), order);
		return "paymentList";
	}
	...
	public String refundList() {
		this.webpage = orderReportManager.listRefund(this.getPage(),
				this.getPageSize(), order);
		return "refundList";
	}
	...
	public String shippingList() {
		this.webpage = orderReportManager.listShipping(this.getPage(),
				this.getPageSize(), order);
		return "shippingList";
	}
	...
	public String returnedList() {
		this.webpage = orderReportManager.listReturned(this.getPage(),
				this.getPageSize(), order);
		return "returnedList";
	}
