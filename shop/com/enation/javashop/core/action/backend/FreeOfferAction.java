...
public class FreeOfferAction extends WWAction {
	...
	public String list() throws Exception {
		this.webpage = freeOfferManager.list(name, order, this.getPage(),
				this.getPageSize());
		return "list";
	}
	...
	public String trash_list() {
		...
		this.webpage = this.freeOfferManager.pageTrash(name, order,
	...
	public String save() {
		...
		if (pic != null) {
			if (FileUtil.isAllowUp(picFileName)) {
				String[] path = UploadUtil.upload(pic, picFileName, "gift",
						120, 120);
