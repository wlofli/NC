...
public class FreeOfferCategoryAction extends WWAction {
	...
	public String list() throws Exception {
		this.webpage = freeOfferCategoryManager.searchFreeOfferCategory(name,
				order, this.getPage(), this.getPageSize());
		return "list";
	}

	public String trash_list() {

		this.webpage = this.freeOfferCategoryManager.pageTrash(name, order,
