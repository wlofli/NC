...
public class OrderAction extends WWAction {
	...
	public String list() {
		...
		this.webpage = this.orderManager.list(this.getPage(),
				this.getPageSize(), 0, searchKey, searchValue, order);
		return "list";
	}

	public String trash_list() {
		this.webpage = this.orderManager.list(this.getPage(),
				this.getPageSize(), 1, searchKey, searchValue, order);
