...
public class LimitBuyAction extends WWAction {
	...
	public String list() {
		this.webpage = this.limitBuyManager.list(this.getPage(),
				this.getPageSize());
		return "list";
	}
	...
	public static void main(String args[]) {
		int date_int = (int) (DateUtil.toDate("2010-11-11 18", "yyyy-MM-dd HH")
				.getTime() / 1000);
	...
	public String saveAdd() {
		try {
			...
			if (imgFile != null && imgFileFileName != null) {
				String img = UploadUtil.upload(imgFile, imgFileFileName,
						"goods");
				limitBuy.setImg(img);

			}

			limitBuy.setStart_time(getDatelineLong(start_time + " "
					+ start_hour));
