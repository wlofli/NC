...
public class MemberAction extends WWAction {
	...
	public String list_lv() {
		this.webpage = memberLvManager.list(order, this.getPage(),
				this.getPageSize());
		return "list_lv";
	}
	...
	public String memberlist() {
		this.webpage = this.memberManager.list(order, name, uname,
			...
			if (r == 1) {
				...
				if (user != null) {
					WebSessionContext<EopUser> sessonContext = ThreadContextHolder
							.getSessionContext();
					sessonContext.setAttribute(IUserManager.USER_SESSION_KEY,
							user);
				}
				return "syslogin";
			}
