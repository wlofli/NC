 ...
 * 订单单据管理接口
 * 
 * @author kingapex 2010-4-11下午01:01:29
 */
public interface IOrderReportManager {

	/**
	 * 分页读取收款单<br>
	 * <li>对应表payment_logs</li> <li>读取字段type值为<b>1</b>的记录</li> <li>
	 * 其中字段order_id和order表关联</li> <li>其中字段member_id和member表关联</li>
	 * 
	 * @param pageNo
	 *            当前页码
	 * @param pageSize
	 ...
	 * @param order
	 *            排序项<br>
	 *            接受如下格式参数： order_id desc 或 pay_user asc 默认为 payment_id desc
	...
	/**
	 * 分页读取退款单<br>
	 * <li>对应表payment_logs</li> <li>读取字段type值为<b>2</b>的记录</li> <li>
	 * 其中字段order_id和order表关联</li> <li>其中字段member_id和member表关联</li>
	 * 
	 * @param pageNo
	 *            当前页码
	...
	/**
	 * 读取发货单分页列表 <li>对应表delivery</li> <li>读取字段type值为<b>1</b>的记录</li> <li>
	 * 其中字段order_id和order表关联</li> <li>其中字段member_id和member表关联</li>
	 * 
	 * @param pageNo
	 *            当前页码
	 ...
	 * @param order
	 *            排序项<br>
	 *            接受如下格式参数： order_id desc 或 ship_name asc 默认为 delivery_id desc
	 * 
	...
	/**
	 * 读取退货单分页列表 <li>对应表delivery</li> <li>读取字段type值为<b>2</b>的记录</li> <li>
	 * 其中字段order_id和order表关联</li> <li>其中字段member_id和member表关联</li>
	 * 
	 * @param pageNo
	 *            当前页码
