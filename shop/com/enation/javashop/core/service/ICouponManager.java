...
public interface ICouponManager {
	 ...
	 * @param coupons
	 *            优惠卷实体<br>
	 *            <li>cpns_status为空则默认为0(禁用状态)</li> <li>cpns_type为空则默认为0(A类优惠卷)</li>
	 *            <li>disabled赋值无效，总为"false"</li>
	 * 
	 * @throws IllegalArgumentException下列情况抛出此异常
	 *             ： <li>如果coupons.cpns_name为空</li> <li>如果coupons.cpns_prefix为空</li>
	 ...
	 * 
	 * @throws IllegalArgumentException下列情况抛出此异常
	 *             ： <li>如果coupons.cpns_id为空</li> <li>如果coupons.cpns_name为空</li>
	 *             <li>如果coupons.cpns_prefix为空</li> <li>如果promotion.pmt_type不为1</li>
	 */
	 ...
	 * 
	 * @throws IllegalArgumentException
	 *             如果cpnsIdArray的大小不等于的大小
	 */
	public void delete(Integer[] cpnsIdArray, Integer[] pmtIdArray);

	/**
	 * 读取所有可添加兑换规则的优惠卷<br>
	 * 即：cpns_type为1(B类优惠卷) 且cpns_point为空 且状态为可用状态
	 * 
	 * @return 优惠卷列表
	 */
	 ...
	 *            需要的积分值
	 * @throws IllegalArgumentException
	 *             ： <li>如果cpnsId为空</li> <li>如果point为空</li>
	 */
