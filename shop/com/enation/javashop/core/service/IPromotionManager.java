 ...
 * 促销规则管理接口
 * 
 * @author kingapex 2010-4-15下午01:36:57
 */
public interface IPromotionManager {
	 ...
	 *            会员级别 id数组，表示限定在优惠范围的会员级别<br>
	 *            如果此数组不为空则进行会员级别与促销规则关联
	 * @param productIdArray
	 *            货品id数组，表示在此范围的货品可享受优惠<br>
	 *            如果此数组不为空，则进行货品与促销规则关联
	 * @throws IllegalArgumentException
	 *             如有下列情况之一： <li>promotion为null</li> <li>pmt_describe为null</li>
	 *             <li>pmts_id(插件id)为null</li> <li>pmt_time_begin为null</li> <li>
	 *             pmt_time_end为null</li>
	 * @return 添加成功后的id
	 */
	...
	/**
	 * 对购物车中的货物应用优惠规则<br>
	 * <li>将货物可享受的优惠规则压入到cartItem.pmtList中</li> <li>
	 * 执行优惠方式，如果对货物的价格有影响，则直接计算优惠后赋给cartItem.coupPrice</li>
	 * 
	 * @param list
	 *            购物车扣货物列表 ，如果为空则不做任何处理
	 * @param memberLvId
	 *            当前购买人的会员级别
	 */
	 ...
	 * @param memberLvId
	 *            会员级别id
	 * @return 优惠价格实体，包含: 优惠后的订单价格， 优惠后的配送费用, 优惠后的积分值
	 ...
	 *            如果此数组不为空，则进行货品与促销规则关联
	 * @throws IllegalArgumentException
	 *             如有下列情况之一： <li>promotion为null</li> <li>pmt_id为null</li> <li>
	 *             pmt_describe为null</li> <li>pmts_id(插件id)为null</li> <li>
	 *             pmt_time_begin为null</li> <li>pmt_time_end为null</li>
	 * 
	 */
