 ...
 * 规格值管理
 * 
 * @author kingapex 2010-3-7下午06:33:06
 */
public class SpecValueManager extends BaseSupport<SpecValue> implements
		ISpecValueManager {
	...
	public List<SpecValue> list(Integer specId) {
		...
		List valueList = this.baseDaoSupport.queryForList(sql,
				new SpecValueMapper(), specId);
		return valueList;
	}

	public Map get(Integer valueId) {
		String sql = "select sv.*,s.spec_type from "
				+ this.getTableName("spec_values") + " sv,"
