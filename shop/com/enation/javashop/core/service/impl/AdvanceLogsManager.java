...
public class AdvanceLogsManager extends BaseSupport implements
	...
	public Page pageAdvanceLogs(int pageNo, int pageSize) {
		...
		Page page = this.baseDaoSupport
				.queryForPage(
						"select * from advance_logs where member_id=? order by mtime DESC",
						pageNo, pageSize, member.getMember_id());
		return page;
	}
