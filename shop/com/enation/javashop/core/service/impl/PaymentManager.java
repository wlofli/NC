 ...
 * 支付方式管理
 * 
 * @author kingapex 2010-4-4下午02:26:19
 */
public class PaymentManager extends BaseSupport<PayCfg> implements
		IPaymentManager {
	...
	public PayCfg get(Integer id) {
		...
		PayCfg payment = this.baseDaoSupport.queryForObject(sql, PayCfg.class,
				id);
		return payment;
	}
	...
	public void add(String name, String type, String biref,
		...
		if (StringUtil.isEmpty(name))
			throw new IllegalArgumentException("payment name is  null");
		if (StringUtil.isEmpty(type))
			throw new IllegalArgumentException("payment type is  null");
		if (configParmas == null)
			throw new IllegalArgumentException("configParmas  is  null");
