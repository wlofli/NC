 ...
 * 促销活动管理接口
 * 
 * @author kingapex 2010-4-15下午12:04:07
 */
public interface IPromotionActivityManager {
	 ...
	 *             如有下列情况之一： <li>activity 为null</li> <li>name 为null</li> <li>
	 *             begin_time 为null</li> <li>end_time 为null</li>
	 */
	 ...
	 *            促销活动
	 * @throws IllegalStateException
	 *             如有下列情况之一： <li>id 为null</li> <li>name 为null</li> <li>
	 *             begin_time 为null</li> <li>end_time 为null</li>
	 */
	 ...
	 * 
	 * @param idArray
	 *            促销活动id数组 如果此参数为null或大小为0则不做任何处理
	 */
