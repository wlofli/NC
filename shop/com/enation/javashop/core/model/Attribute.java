...
public class Attribute {
	...
	/**
	 * 1输入项 可搜索 2输入项 不可搜索 3选择项 渐进式搜索 4选择项 普通搜索 5选择项 不可搜索
	 */
	private int type;
	...
	public int[] getNums() {
		if (nums == null)
			nums = new int[this.getOptionAr().length];
	...
	public static void main(String[] args) {
		...
		// Attribute a = (Attribute)JSONObject.toBean(jsonObject,
		// Attribute.class);
		// System.out.println(a.name + " _- " + a.getType() + "--" +
		// a.getValueList().get(0)); \
		...
		//
		// List<Attribute> list =(List) JSONArray.toCollection(j1,
		// Attribute.class);
