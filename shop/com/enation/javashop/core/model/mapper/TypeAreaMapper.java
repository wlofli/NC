 ...
 * 配送地区-配送方式关联表mapper
 * 
 * @author kingapex 2010-3-30上午08:58:02
 */
public class TypeAreaMapper implements RowMapper {
	...
	public Object mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		JSONObject configJsonObject = JSONObject.fromObject(typeArea
				.getConfig());
		typeArea.setTypeAreaConfig((TypeAreaConfig) JSONObject.toBean(
				configJsonObject, TypeAreaConfig.class));
		return typeArea;
	}
