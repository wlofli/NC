...
public class GoodsField {
	...
	/*
	 * public String getData_source() { return data_source; } public void
	 * setData_source(String dataSource) { data_source = dataSource; } public
	 * Integer getSource_id() { return source_id; } public void
	 * setSource_id(Integer sourceId) { source_id = sourceId; }
	 */
