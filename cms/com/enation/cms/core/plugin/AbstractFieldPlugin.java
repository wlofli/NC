...
public abstract class AbstractFieldPlugin extends AutoRegisterPlugin implements
	...
	public void onSave(Map article, DataField field) {
		...
		article.put(field.getEnglish_name(),
				request.getParameter(field.getEnglish_name()));
	}
	...
	/**
	 * 当前版本cms只支持varchar(255) 和text两种数据类型 定义默认的数据类型，为1(varchar(255))
	 * 子类可覆写此方法返回2为text型。
	 * 
	 * @return
	 * 
