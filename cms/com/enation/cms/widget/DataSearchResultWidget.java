 ...
 * 数据搜索挂件
 * 
 * @author kingapex 2010-7-15下午09:32:37
 */
public class DataSearchResultWidget extends AbstractWidget {
	...
	protected void display(Map<String, String> params) {
		...
		int pageSize = StringUtil.isEmpty(pageSizeParam) ? 20 : Integer
				.valueOf(pageSizeParam);

		HttpServletRequest request = ThreadContextHolder.getHttpRequest();
		String pageParam = request.getParameter("page");
		int pageNo = StringUtil.isEmpty(pageParam) ? 1 : Integer
				.valueOf(pageParam);
		...
		if ("on".equals(pager)) {
			...
			SearchPagerHtmlBuilder pagerHtmlBuilder = new SearchPagerHtmlBuilder(
					pageNo, dataPage.getTotalCount(), pageSize);
